...
1. [ ] The Eclipse community recommends to specify the path to our JVM here.  
...
1. Enter C:\java\jdk1.8.0\_25 \(or /usr/java/...\) as JR
...
http://help.eclipse.org/luna/topic/org.eclipse.platform.doc.isv/reference/misc/runtime-options.html
