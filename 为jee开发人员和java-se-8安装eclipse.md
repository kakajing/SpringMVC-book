...
* [ ] 我们将在本书中使用Eclipse Luna发行版。 我们建议您安装此版本，以便完全符合我们的指南和屏幕截图。 从https//www.eclipse.org/downloads/packages/eclipse-ide-java-ee-developers/lunasr1下载您选择的操作系统和环境的Luna发行版。
